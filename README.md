...
Any use of these results should also cite the FLUKA collaboration, specifically the following publications:

 "The FLUKA Code: Developments and Challenges for High Energy and Medical Applications" <p>
